...
/* WEBPACK VAR INJECTION */(function(jQuery, moment) {/* harmony import */ var _plugin_mvp_presentor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../plugin/mvp/presentor */ "./plugin/mvp/presentor.ts");
  ...
  _createClass(Model, [{
    ...
    value: function getDataModel() {
      var _this3 = _objectSpread({}, this),
          defaultOptions = _this3.defaultOptions,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Presentor", function() { return Presentor; });
...
var Presentor = /*#__PURE__*/function () {
  ...
  _createClass(Presentor, [{
    ...
    value: function destroy() {
      var _this$view2, _this$view3, _this$view4;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(moment) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createDatepicker", function() { return createDatepicker; });
  ...
  if (mode === 'Single' && isMonth) {
    ...
    if (moments[0].hasOwnProperty('start') && moments[0].hasOwnProperty('end')) {
      ...
      if (startMomentMonth === currMonth && endMomentMonth === currMonth) {
        var _mask$querySelector4, _mask$querySelector5;
